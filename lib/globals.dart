...
///this must be stored
Map<String, dynamic> dispenserIngredients = {};
...
List<String> imageLibrary = [
  ...
  'assets/ingredients/tomaten.png',
  'assets/ingredients/lochkas.png',
];

//Maps=========================================================================
///This map holds the current image for each dispenser that the user selected
///This must be stored
Map<String, dynamic> ingrediantSettings = {
...
Map<String, dynamic> typeTranslations = {
  '1': 'Bread',
  '11': 'Brot',
